 ...
 */
final class Version20230530090731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE team (id INT NOT NULL, name VARCHAR(16) NOT NULL, country VARCHAR(20) NOT NULL, money INT NOT NULL, PRIMARY KEY(id))');
